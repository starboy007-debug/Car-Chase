...
{
    [RequireComponent(typeof (CarControllerr))]
    public class CarAIControl : MonoBehaviour
    {
        ...
        private CarControllerr m_CarController;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            m_CarController = GetComponent<CarControllerr>();
